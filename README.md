...
3. Пояснение к задаче regress
   ...
   Получается, что нам нужно найти 3 ближайших точки к точке [5, 5], это будут точки [2, 3], [5, 3], [7, 8], из которых две точки относятся к ноликам и одна к крестикам, то есть наща главная точка принадлежит к крестикам
